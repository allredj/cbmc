...
binary_relation_exprt greater_or_equal_to(const exprt &lhs, const exprt &rhs)
{
  PRECONDITION(rhs.type() == lhs.type());
  return binary_relation_exprt(lhs, ID_ge, rhs);
}

binary_relation_exprt greater_than(const exprt &lhs, const exprt &rhs)
{
  PRECONDITION(rhs.type() == lhs.type());
...
binary_relation_exprt lower_or_equal_to(const exprt &lhs, const exprt &rhs)
{
  PRECONDITION(rhs.type() == lhs.type());
  return binary_relation_exprt(lhs, ID_le, rhs);
}

binary_relation_exprt lower_or_equal_to(const exprt &lhs, mp_integer i)
{
  return lower_or_equal_to(lhs, from_integer(i, lhs.type()));
}

equal_exprt equal_to(const exprt &lhs, const exprt &rhs)
{
  PRECONDITION(rhs.type() == lhs.type());
